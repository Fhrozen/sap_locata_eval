    ...
    for task_idx = 1:length(tasks)
        ...
        for rec_idx = 1:length(recordings)
            ...
            for i = 1:length( array_names)
                ...
                % arr_idx = array_index( array_names{i});
                ...
                for source_cnt = 1:NoS
                    ...
                    if strcmp('Nakadai_I',p_data.name) || strcmp('Nakadai_II',p_data.name)
                        
                        p_array = p_array(:,1:end-1);
                        
                    elseif strcmp('Qian',p_data.name)
                    ...
                    if N_tab == 12 % applies only for one candidate (Qian)
